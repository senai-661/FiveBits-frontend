...
import PAtualizarPaciente from './pages/PAtualizar/PAtualizarPaciente/PAtualizarPaciente'
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path='/atualizar/paciente/:id_paciente' element={<ProtectedRoute element={<PAtualizarPaciente />} />} />
